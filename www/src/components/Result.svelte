...
<section class="box">
    ...
    <div class="marketing">
      ...
      {#if movie.trailer_url}
        <a
          ...
          target="_blank"
          class="external trailer"
          rel="noopener external">Trailer</a
        >
      {/if}
    </div>
  </div>
  ...
  <div class="box">
    <h3 class="icon-label">
      <span class="icon">{movie.recommendation.emoji}</span>{movie
        .recommendation.text}
    </h3>
  </div>
  ...
  <div class="box">
    <h3 class="icon-label">
      <span class="icon">🍅</span>Rotten Tomatoes<ResultMoreLink
        link={movie.links.rotten_tomatoes}
      />
    </h3>
  ...
  <div class="box">
    <h3 class="icon-label">
      <span class="icon">🎬</span>IMDb<ResultMoreLink link={movie.links.imdb} />
    </h3>
  ...
  <div class="box">
    <h3 class="icon-label">
      <span class="icon">📈</span>Metacritic<ResultMoreLink
        link={movie.links.metacritic}
      />
    </h3>
...
<svelte:head>
  ...
  <meta
    ...
    content="{movie.recommendation.emoji} {movie.recommendation.text}"
  />
